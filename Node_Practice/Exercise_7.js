...
var url = process.argv[2]; //url is provided as the 1st command line argument

http.get(url, function callback(response){ //response=node stream obj

	response.setEncoding('utf8'); //has the data converted to a string
